...
class BadgeViewModel(
    ...
    private val MEAL_DESC = "Aggiungi almeno un cibo per Breakfast, Lunch, Dinner e Snack."
    private val MEAL_ICON = "restaurant"

    private val WORKOUT_TITLE = "Primo Workout"
    private val WORKOUT_DESC = "Hai completato il tuo primo workout!"
    private val WORKOUT_ICON = "dumbbell"

    private val TENKM_TITLE = "10 km"
    private val TENKM_DESC = "Completa un percorso di almeno 10 km per la prima volta."
